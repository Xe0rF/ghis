...
for windows_target in aarch64-pc-windows-msvc x86_64-pc-windows-gnu; do
  windows_archive="$project_dir/dist/ghis-v0.4.2-$windows_target.zip"
...
unix_archive="$project_dir/dist/ghis-v0.4.2-$unix_target.tar.gz"
...
archive = Path(sys.argv[1])
package = "ghis-v0.4.2-x86_64-unknown-linux-gnu"
